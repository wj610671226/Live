...
class LiveViewModel: NetWorkProtocol {
    ...
    func loadLiveRoomData(_ roomid: String, _ uid: String, finshedCallBack: @escaping (_ liveUrl: String) -> (),_ failure: @escaping (_ error: String) -> ()) {
    ...
    func loadLiveAddress(_ rUrl: String, callBack: @escaping (_ url: String) -> Void,_ failure: @escaping (_ error: String) ->Void) {
