...
final public class ChatMessage : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        ...
        if !hasName {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(ChatMessage.self): field \"name\" mark required")
        }
...
final public class GiftMessage : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        ...
        if !hasName {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GiftMessage.self): field \"name\" mark required")
        }
        if !hasImgUrl {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GiftMessage.self): field \"imgUrl\" mark required")
        }
        if !hasImgCount {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GiftMessage.self): field \"imgCount\" mark required")
        }
        try userInfo.isInitialized()
    }
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
